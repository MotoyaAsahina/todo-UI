...
import GroupList from '/@/components/SmallList/GroupList.vue'
...
<template>
  <header class="w-full h-3rem bg-gray-100 border-b-1 border-gray-200 relative">
    <div class="h-3rem flex items-center px-4">
